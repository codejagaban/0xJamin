        ...
        <header>
          ...
          ref={boxRef}>
            ...
            <ul className="menu-nav__items">
              ...
              <li className="social">
                <Link to="https://twitter.com/codejagaban"
                      rel="noopener noreferrer"
                ...
                <Link to="https://github.com/codejagaban"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <Link to="https://web.facebook.com/trustjamin"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="social__link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <Link to="https://www.linkedin.com/in/trust-jamin/"
                      rel="noopener noreferrer"
                      target="_blank" className="social__link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                       stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"
                ...
                <Link to="https://dribbble.com/codekyd"
                      rel="noopener noreferrer"
                      target="_blank" className="social__link">
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-dribbble" width="24"
                       height="24" viewBox="0 0 24 24" strokeWidth="1.2" stroke="#505050" fill="none"
